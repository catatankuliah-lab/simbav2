...
class LOFebruariController extends ResourceController
{
    ...
    public function lobytanggal()
    {
        $data = $this->model->getSPMPerKecamtanTanggal(session()->get('id_kantor_cabang'));
        if ($data) {
            return $this->respond($data);
        } else {
            return $this->failNotFound('Data Loading Order (LO)tidak ditemukan.');
    ...
    public function alokasidantanggal($tanggal)
    {
        $data = $this->model->getSPMPerKecamtanTable(session()->get('id_kantor_cabang'), $tanggal);
        if ($data) {
            return $this->respond($data);
        } else {
            return $this->failNotFound('Data Loading Order (LO)tidak ditemukan.');
    ...
    public function semuadataalokasi()
    {
        $data = $this->model->semuadataalokasi(session()->get('id_kantor_cabang'));
        if ($data) {
            return $this->respond($data);
        } else {
            return $this->failNotFound('Data Loading Order (LO)tidak ditemukan.');
    ...
    public function uploadfile1($idlo)
    {
        ...
        $alamatnya = FCPATH  . 'upload/FEBRUARI/WO/' . $namagudang . '/' . $datalo->tanggal_muat . '/';
        $path = 'upload/FEBRUARI/WO/' . $namagudang . '/' . $datalo->tanggal_muat . '/';
    ...
    public function uploadfile2($idlo)
    {
        $datalo = $this->model->getkebutuhanupload($idlo);
        $namagudang = substr($datalo->nama_gudang, 5);
        $alamatnya = FCPATH  . 'upload/FEBRUARI/LO/' . $namagudang . '/' . $datalo->tanggal_muat . '/';
        $path = 'upload/FEBRUARI/LO/' . $namagudang . '/' . $datalo->tanggal_muat . '/';
    ...
    public function uploadfile3($idlo)
    {
        $datalo = $this->model->getkebutuhanupload($idlo);
        $namagudang = substr($datalo->nama_gudang, 5);
        $alamatnya = FCPATH  . 'upload/FEBRUARI/DO/' . $namagudang . '/' . $datalo->tanggal_muat . '/';
        $path = 'upload/FEBRUARI/DO/' . $namagudang . '/' . $datalo->tanggal_muat . '/';
