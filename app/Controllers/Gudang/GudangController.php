...
class GudangController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->modelLOFebruari = new LOJanuariModel();
    ...
    function downloadPDFLOJanuari($nomorlo)
    {
        ...
        $html .= '<tr>
                    ...
                    <td width="25%">: ' . $datalo[0]->nomor_lo . '</td>
        ...
        $html .= '<tr style="text-align: center">
                    ...
                    <th style="width: 10%">Jumlah Diserahkan (Kg)</th>
                    <th style="width: 7.5%">Kondisi</th>
                    <th style="width: 7.5%">Koll (Bags)</th>
                    <th style="width: 7.5%">Cek Isi (Y/N)</th>
                    <th style="width: *%">Desa/Kecamatan</th>
                </tr>';
        ...
        foreach ($datalo as $row) {
            ...
            $pdf->SetFont('times', '', 8);
            $pdf->Cell(0, 0, 'Gedung Pos Ibukota', 0, 1, 'L');
            $pdf->Cell(0, 0, 'Jl. Lapangan Banteng Utara No. 1', 0, 1, 'L');
            $pdf->Cell(0, 0, 'Jakarta Pusat 10710', 0, 1, 'L');
            $pdf->Ln(0);
            $pdf->SetFont('times', 'B', 8);
            ...
            $html .= '<tr>
                    ...
                    <td width="25%">: ' . $row->tanggal_muat . '</td>
            ...
            $html .= '<tr>
                    <td width="25%">Tujuan (Kec/Kel)</td>
                    <td width="25%">: ' . $row->nama_kecamatan . '/' . $row->nama_desa_kelurahan . '</td>
            ...
            $html2 .= '<tr>
                            ...
                            <td style="text-align:center; width: 30%" rowspan="2">Nama Produk</td>
                            <td style="text-align:center; width: 87px" >Berat</td>
                            <td style="text-align:center; width: 87px" >QTY</td>
                            <td style="text-align:center; width: 87px" rowspan="2">Jumlah PBP</td>
                            <td style="text-align:center; width: 87px" rowspan="2">Ket</td>
                        </tr>
                        <tr>
            ...
            $html2 .= '<tr>
                            ...
                            <td style="text-align:center; width: 30%">Beras Bantuan Pangan Kemasan 10 Kg</td>
                            <td style="text-align:center; width: 87px" >' . $row->jumlah_penyaluran_januari . '</td>
                            <td style="text-align:center; width: 87px" >' . $row->jumlah_penyaluran_januari / 10 . '</td>
                            <td style="text-align:center; width: 87px">' . $row->jumlah_penyaluran_januari / 10 . '</td>
                            <td style="text-align:center; width: 87px">Ket</td>
                        </tr>';
            $html2 .= '</table>';
            // Output the HTML content to the PDF
            ...
            $html3 .= '<tr style="text-align: center">
                    <td width="50%" height="20px">Diserahkan Oleh<br>EGM/EM/Tim Satgas</td>
                    <td width="50%" height="20px">Diterima Oleh<br>KCP/Tim Satgas/Aparat Setempat</td>
                </tr>';
            $html3 .= '<tr style="text-align: center;">
                    <td width="50%" height="55px"></td>
                    <td width="50%" height="55px"></td>
                </tr>';
            $html3 .= '<tr>
                    <td width="50%"><br><hr><br>Nippos : </td>
                    <td width="50%"><br><hr><br></td>
                </tr>';
            $html3 .= '</table>';
