    ...
    <div class="col-md-12 col-lg-12">
        <div class="card-body">
            ...
            <h6 class="card-subtitle mb-3">
                Klik <a style="font-weight: bolder;" href="<?= base_url('gudang/spmbast') ?>">disini</a> untuk mengelola Loading Order (LO)
            </h6>
            <div class="row">
            ...
            <h6 class="card-subtitle mb-3" id="lengkap">
                <a href="<?= base_url('gudang/spmbast/generatelaporan/' . $nomorlo) ?>" style="font-weight: bolder;" class="text-primary" id="downloadspm">Download</a> File Bukti Penyerahan Loading Order (LO) & Surat Jalan
            </h6>
        </div>
    </div>
</div>
<script src="<?= base_url('assets/js/gudang/spmbast/getdetailspmbast.js') ?>"></script>
<?php $this->endSection() ?>