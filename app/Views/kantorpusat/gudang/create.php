        ...
        <div class="card-body">
            ...
            <div class="row mt-4">
                ...
                <div class="col-12 mt-3">
                    <button type="button" style="height: 50px !important; font-size: 14px;" class="btn waves-effect custom-shadow waves-light btn-rounded btn-primary w-100" id="simpangGudang">Simpan Data</button>
                </div>
            </div>
        </div>
    </div>
</div>
<script src="<?= base_url('assets/js/kantorpusat/gudang/postgudang.js') ?>"></script>
<?php $this->endSection() ?>