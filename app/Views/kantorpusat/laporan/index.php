    ...
    <div class="col-md-12 col-lg-12">
        <div class="card-body">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-4 px-4 mt-3">
                    <label for="pilihtanggal" class="h6">Pilih Tanggal</label>
                    <select class="form-control custom-shadow custom-radius border-0 bg-white text-secondary px-4" id="pilihtanggal" name="pilihtanggal" style="height: 50px !important; font-size: 14px;" placeholder="Pilih Tanggal">
                        <option value="0" selected disabled>Pilih Tanggal</option>
                    </select>
                </div>
                <div class="col-md-4 my-3 mt-5">
                    <button type="button" style="height: 50px !important; font-size: 14px;" class="btn waves-effect custom-shadow waves-light btn-rounded btn-primary w-100" id="tampilkan" name="tampilkan">Filter Document</button>
                </div>
            </div>
...
<script src="<?= base_url('assets/js/kantorcabang/laporan/getallwo.js') ?>"></script>
<?php $this->endSection() ?>