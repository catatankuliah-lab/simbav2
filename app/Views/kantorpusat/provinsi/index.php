...
<div class="row">
    <div class="col-md-12 col-lg-12">
        <div class="card-body">
            <h5 class="card-title mb-1">Kelola Provinsi</h5>
            <p style="font-size: 11px;">Sistem Informasi Manajamen Bantuan Pangan</p>
            <h6 class="card-subtitle mt-2 mb-3">
                Klik <a style="font-weight: bolder;" href="<?= base_url('kantorpusat/prov/create-prov') ?>">disini</a> untuk mengelola Provinsi
            </h6>
