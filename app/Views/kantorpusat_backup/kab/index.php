...
<div class="row">
    <div class="col-md-12 col-lg-12">
        <div class="card-body">
            <h5 class="card-title mb-1">Kelola Kabupaten/Kota</h5>
            <p style="font-size: 11px;">Sistem Informasi Manajamen Bantuan Pangan</p>
            <h6 class="card-subtitle mt-2 mb-3">
                Klik <a style="font-weight: bolder;" href="<?= base_url('kantorpusat/kabkota/create-kabkota') ?>">disini</a> untuk mengelola Kabupaten/Kota
            </h6>
