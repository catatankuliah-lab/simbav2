...
$.ajax({
  ...
  success: function (data) {
    ...
    output2.attr("src", "https://delapandelapanlogistics.com/" + data.data.path_lo + data.data.file_uplaod_lo);
    output3.attr("src", "https://delapandelapanlogistics.com/" + data.data.path_uplaod_do + data.data.file_upload_do);
...
function editpenerimaan(idsj, index) {
  ...
  $.ajax({
    url: "https://delapandelapanlogistics.com/api/sj/" + $('#alokasi').val() + "/jampenerimaan/editdatajs/" + idsj,
    type: "POST",
    dataType: "json",
...
$('#file1').change(function (e) {
  ...
  loadingswal();
  $.ajax({
    url: "https://delapandelapanlogistics.com/api/lo/" + $('#alokasi').val() + "/uploadfile/1/" + $('#idlo').val(),
    type: "POST",
    data: formData,
    processData: false,
    contentType: false,
...
$('#file2').change(function (e) {
  ...
  loadingswal();
  $.ajax({
    url: "https://delapandelapanlogistics.com/api/lo/" + $('#alokasi').val() + "/uploadfile/2/" + $('#idlo').val(),
    type: "POST",
    data: formData,
    processData: false,
    contentType: false,
...
$('#file3').change(function (e) {
  ...
  loadingswal();
  $.ajax({
    url: "https://delapandelapanlogistics.com/api/lo/" + $('#alokasi').val() + "/uploadfile/3/" + $('#idlo').val(),
    type: "POST",
    data: formData,
    processData: false,
    contentType: false,
...
$('#prosesedit').click(function (e) {
  ...
  $.ajax({
    url: "https://delapandelapanlogistics.com/api/lo/" + $('#alokasi').val() + "/editdatalo/" + $('#idlo').val(),
    type: "POST",
    dataType: "json",
    contentType: "application/json",
    data: JSON.stringify(additionalData),
